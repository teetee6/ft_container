...
int main()
{
    ...
    int b[1]; b[0]=3;
    ft::__wrap_iter<int> a(b);
    std::cout << *a << std::endl;
    std::cout << a.operator->() << std::endl;
    
    ft::pair<int, char> tmp(1, 2);
    ft::__wrap_iter<ft::pair<int, char> > c(&tmp);
    ...
    ft::__wrap_iter<char> ft_from1(from1.base()), ft_from2(from2.base()), ft_from3(from3.base()), ft_end1(end1.base());
